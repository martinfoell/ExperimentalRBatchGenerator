...
struct RChunkConstructor {
   ...
   void CreateChunksIntervals() {
      ...
      for (size_t i = 0; i < FullChunks; i++) {
         ...
         ChunksIntervals[i].insert(ChunksIntervals[i].end(), FullBlockIntervalsInFullChunks.begin() + start_FullBlock, FullBlockIntervalsInFullChunks.begin() + end_FullBlock);
      ...
      for (size_t i = 0; i < LeftoverChunks; i++) {
         ...
         ChunksIntervals[j].insert(ChunksIntervals[j].end(), FullBlockIntervalsInLeftoverChunks.begin() + start_FullBlock, FullBlockIntervalsInLeftoverChunks.begin() + end_FullBlock);
